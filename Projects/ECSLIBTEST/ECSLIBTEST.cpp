...
class TransformNodeTest : public ECS::TransformNode
{
public:
	using ECS::TransformNode::TransformNode;
	~TransformNodeTest() = default;
};

using TransformNode = TransformNodeTest;
using ECS::WorldTransformProxy;
using ECS::LocalTransformProxy;
using ECS::ReparentLogic;
